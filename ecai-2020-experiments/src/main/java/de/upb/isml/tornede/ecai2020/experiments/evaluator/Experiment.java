...
public class Experiment {
	...
	public void runExperiment(int datasetSplit, List<Integer> trainingDatasets, List<Integer> testDatasets, IdBasedRanker ranker, List<Metric> metrics) throws SQLException {
